...
export class EditarProductoComponent implements OnInit {
  ...
  @Output() productoClickeado = new EventEmitter<Producto>();
  ...
  /* mostrarListaProductos(avesFiltradas: Producto[]): void {
    this.productoFiltrado=avesFiltradas;
    this.cargaDetalleProducto.recargar()
  } */

  asignarProductoClickeado(producto: Producto) {
    console.log(producto);
    this.productoClickeado.emit(producto);
  }
